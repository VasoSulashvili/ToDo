...
export default {
    ...
    computed: {
        style() {
            return {
                'bg-green-700 dark:bg-green-700': this.type === 'success',
...
<template>
    ...
    <div>
<!--        dark:bg-gray-700-->
        <div :class="style" class="absolute bottom-5 right-5 max-w-xs  text-sm text-white rounded-md shadow-lg  mb-3 ml-3" role="alert">
            <div class="flex p-4">
                {{ message }}
